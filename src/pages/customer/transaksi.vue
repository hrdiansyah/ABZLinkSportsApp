    ...
    <div class="row justify-center">
        ...
        <div class="col">
            <div class="row">
                ...
                <div class="col-1 q-gutter-lg" />
                <div class="col-2">
                    <q-input borderless type="number" v-model="form.Jumlah" label="Jumlah" lazy-rules :rules="[ val => val !== null && val !== '' || 'Please Insert Jumlah']" />
                </div>
                <div class="col-1 q-gutter-lg" />
...
export default {
    data() {
        return {
            ...
            prov: ['Aceh', 'Bali', 'Bangka Belitung', 'Banten', 'Bengkulu', 'Gorontalo', 'Jakarta', 'Jambi', 'Jawa Barat', 'Jawa Tengah', 'Jawa Timur', 'Kalimantan Timur', ' Kalimantan Utara', 'Kepulauan Riau', 'Lampung', 'Maluku', 'Maluku Utara', 'Nusa Tenggara Barat', 'Nusa Tenggara Timur', 'Papua', 'Papua Barat', 'Riau', 'Sulawesi Barat', 'Sulewasi Selatan', 'Sulawesi Selatan', 'Sulawesi Tengah', 'Sulawesi Tenggara', 'Sulawesi Utara', 'Sumatra Barat', 'Sumatra Selatan', 'Sumatra Selatan', 'Sumatra Utara', 'Yogyakarta'],
    ...
    computed: {
        ...
        Discont: function () {
            ...
            } else if (this.form.diskon == 'ORDER NOW') {
                return parseInt(30000)
            }else if (this.form.diskon == 'ORDER') {
                return parseInt(10000)
            }else if (this.form.diskon == 'NEW MEMBER') {
                return parseInt(30000)
            }else if (this.form.diskon == 'MEMBER') {
                return parseInt(10000)
            } else {
                return parseInt(0)
            }
    ...
    methods: {
        ...
        beli() {
            ...
            payment.postPayment(window, self.images.product_name, self.cust_Name, self.images.harga, self.form.Ukuran, self.form.Jumlah,
                    ...
                    console.log(self.images.product_name, self.cust_Name, self.images.harga, self.form.Ukuran, self.form.Jumlah,
                    self.form.Catatan, self.form.Alamat, self.form.Kecamatan, self.form.Kota, self.form.Negara, self.form.Provinsi,
                    self.form.Kodepos, self.form.Tlp, self.form.Shipping, self.form.metode_pembayaran,
                    self.Discont, self.Biaya_kirim, self.Sub_total, self.Total, self.images.imgurl)
